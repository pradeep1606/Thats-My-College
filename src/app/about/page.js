    ...
    <>
      <div className=' h-fit w-full bg-[#FAFAFA] font-serif'>
        ...
        <div className='w-full h-fit flex flex-col sm:flex-row items-center justify-center gap-5 sm:px-28 sm:py-10'>
          <div className=' bg-[#FFFFFF]  sm:w-2/4 sm:h-[52vh]  w-11/12 flex items-center justify-center flex-col text-center gap-5 [box-shadow:0px_15px_30px_5px_rgba(0,0,0,0.06)] px-10 py-5'>
          ...
          <div className=' bg-[#FFFFFF]  sm:w-2/4 sm:h-[52vh] w-11/12 flex overflow-y-auto [&::-webkit-scrollbar]:hidden items-center justify-center flex-col text-center gap-5 [box-shadow:0px_15px_30px_5px_rgba(0,0,0,0.06)] px-10 py-5'>
